...
<HTML>
<body BGCOLOR=#000000>
<form name="form1" method="post" action="inicioempleado.php">
  <table width="991" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td width="76" bgcolor="#666666"><FONT COLOR=#FFFFFF>DNI:</FONT></td>
      <td width="170" bgcolor="#666666"><input name="dni" type="text" id="dni"></td>
