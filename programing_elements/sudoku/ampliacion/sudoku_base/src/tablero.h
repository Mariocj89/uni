...
POST: elimina un valor de los posibles de las celdas que estan en la columna, fila y zona de la posicion dada por el tablero.
*/
void EliminarPosiblesTablero(tablero &tab);

/**
PRE: deben darnos un tablero y el valor a añadir.
POST: añade un valor dado a los posibles de las celdas que estan en la columna, fila y zona.
*/
void AniadirPosiblesTablero(tablero &tab, int n);

/** Modulos para la busqueda de valores*/
